...
function Hero() {
  return (
    <section className="relative overflow-hidden bg-hero-glow">
      <div className="absolute inset-0 -z-10 bg-gradient-to-br from-[#05213d] via-primary to-[#018c90] dark:from-slate-900 dark:via-slate-900 dark:to-primary/60" />
      <div className="absolute inset-0 -z-10 opacity-40">
        <div className="mx-auto h-full max-w-17xl bg-[radial-gradient(circle_1000px_at_0%_0%,rgba(73, 100, 199, 15),transparent)]" />
      </div>
      <div className="section-max relative flex flex-col gap-12 py-24 lg:flex-row lg:items-center lg:gap-16 lg:py-32">
        <motion.div
          className="max-w-2xl text-white drop-shadow-[0_8px_24px_rgba(0,0,0,0.35)]"
          initial={{ opacity: 0, y: 40 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8, ease: 'easeOut' }}
        >
          <span className="inline-flex items-center rounded-full bg-white/20 px-4 py-1 text-xs text-blue-600 font-semibold uppercase tracking-[0.3em] text-white/80">
            C-DAC Mumbai × ACPCE
          </span>
          <h1 className="mt-5 text-3xl font-bold leading-tight md:text-2xl lg:text-5xl bg-[radial-gradient(circle_at_center,_#3b82f6,_#9333ea,_#ec4899)] bg-clip-text text-transparent">
            Cyber Hygiene Model United Nations 2025
          </h1>

          <p className="mt-6 text-lg md:text-xl bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent">
